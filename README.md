...
git clone https://github.com/eosoukaina/active-learning-classifier.git
...
### Reporting Issues
Found a bug or have a feature request? Please open an issue on [GitHub Issues](https://github.com/eosoukaina/active-learning-classifier/issues).
